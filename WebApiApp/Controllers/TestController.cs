...
namespace WebApiApp.Controllers
{
    ...
    {
        SqlConnection sqlcon = new SqlConnection("server=LAPTOP-V2H8Q5Q5;database=ustdb;Integrated Security=true");
        ...
        public HttpResponseMessage Put(int id, [FromBody] Player b)
        {
            ...
            {
                msg = Request.CreateResponse(HttpStatusCode.NotFound, "Student Not Found");
            }
            else
            {
                sqlcon.Open();
